...
parser.add_argument('--root_path', type=str, default='/home/jovyan/shared/xinzeli/CORN/code/', help='Name of Experiment')
...
if FLAGS.dataset_name == "LA":
    ...
    image_list = [FLAGS.root_path + "/2018LA_Seg_Testing Set/" + item.replace('\n', '') + "/mri_norm2.h5" for item in
                  image_list]
